...
Module: OTHER
Contains functions that don't belong in any of the other modules
...
void __cpuHoldDelay(uint32_t uS); // Holds the CPU in a loop for the specified duration in microseconds